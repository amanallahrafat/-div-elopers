...
hodRouter.put('/updateCourseInstructor', authorization.authStaffMember, hodController.updateCourseInstructor);
hodRouter.delete('/deleteCourseInstructor', authorization.authStaffMember, hodController.deleteCourseInstructor);
